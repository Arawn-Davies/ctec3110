...
DROP DATABASE IF EXISTS stockquote_db;

CREATE DATABASE IF NOT EXISTS stockquote_db COLLATE utf8_unicode_ci;

--
-- Create the user account
--
CREATE USER 'stockquote_user'@'localhost' IDENTIFIED BY 'stockquote_user_pass';
GRANT SELECT, INSERT ON stockquote_db.* TO 'stockquote_user'@'localhost';
