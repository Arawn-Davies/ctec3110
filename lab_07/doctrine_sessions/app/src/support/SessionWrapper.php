...
class SessionWrapper
{
	...
	public static function setSessionVar($session_key, $session_value_to_set)
	{
	...
	public static function getSessionVar($session_key)
	{
		$session_value = false;
	...
	public static function unsetSessionVar($session_key)
	{
		$unset_session = false;
		if (isset($_SESSION[$session_key]))
		{
